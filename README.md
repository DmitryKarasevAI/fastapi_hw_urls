...
- Выполнить docker compose up --build (иногда запускается со второй попытки, просто запустить команду ещё раз)
- Также можно посмотреть готовое развёрнутое решение [здесь](http://84.252.135.10:9999/docs#/).
